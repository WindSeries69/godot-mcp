...
const METHOD_CATALOG: Record<string, string[]> = {
  ...
  node: ["add_node", "delete_node", "duplicate_node", "move_node", "update_property", "get_node_properties", "add_resource", "rename_node", "connect_signal", "disconnect_signal", "get_node_groups", "set_node_groups"],
  script: ["list_scripts", "read_script", "create_script", "edit_script", "attach_script", "get_open_scripts", "validate_script"],
  editor: ["get_editor_errors", "get_output_log", "get_editor_screenshot", "get_game_screenshot", "execute_editor_script", "clear_output", "reload_plugin", "reload_project", "get_signals"],
  input: ["simulate_key", "simulate_mouse_click", "simulate_mouse_move", "simulate_action", "simulate_sequence"],
  runtime: ["get_game_scene_tree", "get_game_node_properties", "set_game_node_property", "capture_frames", "monitor_properties", "execute_game_script", "find_nodes_by_script", "find_ui_elements", "click_button_by_text", "wait_for_node", "navigate_to", "move_to"],
  ...
  batch: ["find_nodes_by_type", "find_signal_connections", "batch_set_property", "find_node_references", "get_scene_dependencies", "cross_scene_set_property"],
